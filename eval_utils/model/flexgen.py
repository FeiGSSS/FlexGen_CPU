...
@register_model("flexgen", "flexgen-cxl", "flexgen_cxl", "flexgen-cpu", "flexgen_cpu")
class flexgen(TemplateLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if str(args.batch_size).startswith("auto"):
        ...
        self.num_prompts = args.num_batches * args.batch_size
        ...
        self.env = ExecutionEnv(cpu=cpu, disk=disk, numa=numa)
        self.policy = Policy(
                    args.batch_size,
                    args.num_batches,
                    args.percent[0],
